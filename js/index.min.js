...
minus.addEventListener("click",function(){
    ...
    d=void 0;if([].concat(_toConsumableArray(c.children)).map(function(a){
        ...
        c.appendChild(d)}),pause.addEventListener("click",
        function(){
    ...
    "pause"!==a.id&&(a.disabled=!playing)})}),commentForm.addEventListener("submit",function(a){
        a.preventDefault();var b=this.children[0],c=b.value;b.value="";
